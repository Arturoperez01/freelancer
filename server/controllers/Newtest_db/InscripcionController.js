...
import InscripcionControllerGenerated from "./generated/InscripcionControllerGenerated";
...
const customControllers = {
   ...
   *
   ...
   init: router => {
     ...
     // Init super
     InscripcionControllerGenerated.init(router);
    },
...
export default {
  ...InscripcionControllerGenerated,
  ...customControllers
};
