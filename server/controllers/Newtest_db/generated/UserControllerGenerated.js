...
const generatedControllers = {
  ...
  init: router => {
    ...
    router.post(baseUrl + "/:id/changePassword", authorize([]), UserController.changePassword);
    router.post(baseUrl + "/signup", UserController.signup);
    router.post(baseUrl + "",authorize(['ADMIN']), UserController.create);
    ...
    /*
    router.post(baseUrl + "admin/:id", authorize([]), UserController.update);
    router.post(baseUrl + "admin", authorize([]), UserController.create);
    router.delete(baseUrl + "admin/:id", authorize([]), UserController.delete);
    router.get(baseUrl + "admin/:id", authorize([]), UserController.get);
    router.get(baseUrl + "admin", authorize([]), UserController.list);
    router.post(baseUrl + "admin/:id", authorize([]), UserController.update);
    //*/
  },
